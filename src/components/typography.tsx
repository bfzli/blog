...
export const H1 = (props: HeadingProps) => <h1 {...{ class: styles.h1, ...props }}>
    {props.children}
</h1>

export const H2 = (props: HeadingProps) => <h2 {...{ class: styles.h2, ...props }}>
    {props.children}
</h2>

export const H3 = (props: HeadingProps) => <h3 {...{ class: styles.h3, ...props }}>
    {props.children}
</h3>

export const H4 = (props: HeadingProps) => <h4 {...{ class: styles.h4, ...props }}>
    {props.children}
</h4>

export const H5 = (props: HeadingProps) => <h5 {...{ class: styles.h5, ...props }}>
    {props.children}
</h5>

export const H6 = (props: HeadingProps) => <h6 {...{ class: styles.h6, ...props }}>
    {props.children}
</h6>
